...
void initEPWM()
{
  ...
  EPwm1Regs.CMPA.bit.CMPA = cmpr1;     // Set compare A value
  EPwm1Regs.CMPB.bit.CMPB = cmpr1;               // Set Compare B value
  // Setup counter mode
  ...
  EPwm2Regs.CMPA.bit.CMPA = cmpr2;     // Set compare A value
  ...
  EPwm3Regs.CMPA.bit.CMPA = cmpr3;     // Set compare A value
...
//    a = HalfPWM + HalfPWM * sin(th);
//    b = HalfPWM + HalfPWM * sin(th - 0.6667 * M_PI);
//    c = HalfPWM + HalfPWM * sin(th + 0.6667 * M_PI);
