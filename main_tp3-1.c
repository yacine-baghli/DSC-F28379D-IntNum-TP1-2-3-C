...
// Variables
int Count = 0;
float facteur = 5000.0/4095.0;
Uint16 cmpr = HalfPWM;
Uint16 ADCIref=0, ADCImes=0;

float Imes =0.0, Iref=0.0;

float a=(8.0/0.6)*(3.3/4095.0);
float b = -100.0/3.0;
float c = (8.0/1.65)*(3.3/4095.0);
float d =-8.0;

double alpha=0, Kp=0.1, Ki=0.0001, xe_I=0, e=0;
...
interrupt void adca1_isr(void)
{
  ...
  Iref = ADCIref*c +d;   // +/-8A
  Imes = ADCImes*a +b;   // calibre LTS25 à 8A


  cmpr = ADCIref*facteur;
